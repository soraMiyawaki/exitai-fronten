        ...
        <div className="mx-auto max-w-6xl px-4 h-16 flex items-center gap-4">
          ...
          <div className="hidden md:flex items-center flex-1 mx-4">
            <div className="flex items-center gap-2 w-full glass rounded-2xl px-3 py-2">
              <svg width="16" height="16" viewBox="0 0 24 24" className="opacity-70"><path fill="currentColor" d="M15.5 14h-.79l-.28-.27A6.471 6.471 0 0 0 16 9.5A6.5 6.5 0 1 0 9.5 16a6.471 6.471 0 0 0 4.23-1.57l.27.28v.79L20 21.5L21.5 20zM4 9.5C4 6.46 6.46 4 9.5 4S15 6.46 15 9.5S12.54 15 9.5 15S4 12.54 4 9.5"/></svg>
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <img src="/brand.jpg" alt="me" className="h-9 w-9 rounded-full object-cover ring-1 ring-slate-200 dark:ring-slate-800" />
          </div>
        </div>
      </header>
